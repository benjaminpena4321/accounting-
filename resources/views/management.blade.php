...
<div class="container">
    ...
    <div class="row filterClass">
        ...
        <div class="col-lg-10" >
            ...
            <form action="{{url('/manage')}}" method="GET">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 ">
                    @if($search == 1)
                            <a href="/manage" class="btn btn-outline-light undoSearchClass">
        ...
        <div class="col-lg-2" >
            ...
            <a  class="btn btn-outline-light addClass" href="/manageAdd">Add User</a>
        </div>
    ...
    <table class=" table table-striped"  style="text-align: center;">
        <thead>
            ...
            <div class="row">
                <th scope="col">
                        <a href="/manage/{{$sort}}/id"># @if($sort == "ASC") <i class="fas fa-arrow-up fa-xs"></i> @else <i class="fas fa-arrow-down fa-xs"></i> @endif</a>
                </th>
            </div>
                <th scope="col">
                    <a href="/manage/{{$sort}}/name">Name @if($sort == "ASC") <i class="fas fa-arrow-up fa-xs"></i> @else <i class="fas fa-arrow-down fa-xs"></i> @endif </a> 
                </th>
                <th scope="col">
                    <a href="/manage/{{$sort}}/level">Level @if($sort == "ASC") <i class="fas fa-arrow-up fa-xs"></i> @else <i class="fas fa-arrow-down fa-xs"></i> @endif </a> 
                </th>
            ...
            @foreach($datas as $data)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/manageEdit/{{$data->id}}"  class="btn btn-warning"><i class="fas fa-edit"></i></a>
                         @if($data->deleted_at != NULL)
                         <a href="/manageRestore/{{$data->id}}" class="btn btn-info"><i class="fas fa-trash-restore"></i></a>
                        @else 
                         <a href="/manageRemove/{{$data->id}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                        @endif 
